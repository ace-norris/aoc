...
func Test_Exercise1(t *testing.T) {
	...
	cs := []struct {
	...
	}{
		{
			...
			Stream: `Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
	...
	// act
	for i, c := range cs {
		out := Exercise1(c.Stream, c.Possibilites)
...
const stream = `Game 1: 8 green, 4 red, 4 blue; 1 green, 6 red, 4 blue; 7 red, 4 green, 1 blue; 2 blue, 8 red, 8 green
